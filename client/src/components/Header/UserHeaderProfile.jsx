                ...
                <div className='profile-header'>
                    {
                        ...
                        <>
                            {
                                user[0].avatar ? <img  className='profile-image' src={`${baseUrl}/avataruser/${user[0].avatar}`} alt={user[0].user_name} />
                                :
                                <img className='profile-image' src='https://ideogram.ai/api/images/direct/a9clBXDhS_GtGnjN4dzfKg' alt={user[0].user_name}></img> 
                            }
